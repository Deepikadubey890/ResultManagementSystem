...
<body>
  <center>
    <marquee behavior="scroll" style="color: #FFF; top:60PX; font-size:40px; background-color:red;">GOVERNMENT RESULT HAS BEEN ANNOUNCED!!!</marquee>
    ...
    <div class="content">
      <div class="content3" style="height: 45%">
        ...
        $sql = "SELECT name, roll, class, language , math, physics, chemistry,activities ,totalmarks,result FROM result1 WHERE roll = $roll AND class = $class LIMIT 1 ";
        ...
        <div class="list">LANGUAGE: ' . $row["language"] . '</div>
         ...
         <div class="list">ACTIVITIES: ' . $row["activities"] . '</div>
         <div class="list">TOTAL MARKS OBTAINED: ' . $row["totalmarks"] . '</div>
         <div class="list" id="result">RESULT:' . $row["result"] . '</div>';
          }
        } else {
